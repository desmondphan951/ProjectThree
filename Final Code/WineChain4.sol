...
contract WineChain4{
   ...
   // Function to transfer Ether from this contract to address from input
    ...
    function getbalance() public view returns(
        uint _smartcontractbalance,
        address _smartcontractaddress,
        uint _ownerwalletbalance,
        address _ownerwalletaddress
        )
        {
            _smartcontractbalance = address(this).balance;
            _smartcontractaddress = address(this);
            _ownerwalletaddress = owner;
            _ownerwalletbalance = owner.balance;
        }
